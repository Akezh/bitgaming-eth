...
export declare namespace Leaderboard {
  export type UserStruct = { addr: AddressLike; balance: BigNumberish };

  export type UserStructOutput = [addr: string, balance: bigint] & {
    addr: string;
    balance: bigint;
  };
}

export interface BITTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BITToken extends BaseContract {
  connect(runner?: ContractRunner | null): BITToken;
  ...
  burnTokens: TypedContractMethod<
    [target: AddressLike, tokens: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getUsers: TypedContractMethod<[], [Leaderboard.UserStructOutput[]], "view">;
  ...
  rewardTokens: TypedContractMethod<
    [users: AddressLike[], tokens: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[tokens: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[], [Leaderboard.UserStructOutput[]], "view">;
  getFunction(
